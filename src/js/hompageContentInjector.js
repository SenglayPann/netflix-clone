  ...
  .then(() => {
    ...
    const setOpenById = (button) => {
      button.addEventListener("click", () => {
        const modalImgAttribute = modal.querySelector(".modal-thumbnail-img img");
        const modalLogo = document.getElementById('modal-movie-logo');
        modalLogo.setAttribute('src', 'https://occ-0-64-58.1.nflxso.net/dnm/api/v6/E8vDc_W8CLv7-yMQu8KMEC7Rrr8/AAAABcLpSju4Bca033VV18qJR0gkqgBxzqwP37D_SrVh7Mm1UrDFD_PSUKL-OzoLaK7_FPagGURmN-0wiJYRrrC5mt7kLdj9vlepK67K.webp?r=ee2')
        modalImgAttribute.setAttribute(
          "src",
          'https://occ-0-64-58.1.nflxso.net/dnm/api/v6/tx1O544a9T7n8Z_G12qaboulQQE/AAAABRlIR27EzAZoB8RVTpO9K-Svvcg-cC9-lMAGWtV9Q2gANlBN9GFtbhOQdBrgRGE3zLgSsj1ikNIS279Kaeh-n3LrHzgSThItNXwchtoEuzfSA457gUSbz-C0OT4qbbzts-cvMyzvVr8oOnwQN310hXb7Kl6LjgkzCnbXkfSAWfhlY4SSkXqz.webp?r=de5'
        );
