    ...
    .then(data => {
            ...
            <div class="img-container modalOpenButton">
              ...
              <div class="hidden-info-card">
                ...
                <div class="card-dummy-video" >
                  <video src="../src/video/dummy_video.mp4" autoplay loop muted></video>
                </div>
                  ...
                  <div class="card-info-wrapper">
                    ...
                    <div class="movie-brief-info">
                      <div class="brief-top">
                        ...
                        <div class="brief-age-rate">13+</div>
                        <div class="number-of-ep">16 Episodes</div>
        ...
        <div class="carousel-progress-container">
          <div class="genre-title">
            <div class="title-name">Recently Added</div>
